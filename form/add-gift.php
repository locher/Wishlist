...
if(isset($designation) && $designation != ''){
	...
	$saveBDD = $bdd->prepare("INSERT INTO ".$config['db_tables']['db_gifts']." (ID, userID, title, link, description, isList, isReserved, reservationUserID, reservationGuestName) VALUES (NULL, :userID, :title, :link, :description, :isList, 0, 0, '')");
